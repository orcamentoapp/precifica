...
export default function AdminDashboard({ onLogout }) {
  ...
  return (
    <div className={`min-h-screen bg-stone-50 font-sans ${theme === "dark" ? "dark" : ""}`}>
            ...
            {statsLoading || !stats ? (
              ...
              <>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <StatCard icon={Users} tone="indigo" label="Usuários totais" value={stats.totalUsers} />
                  <StatCard icon={Activity} tone="teal" label="Assinantes pagos ativos" value={stats.activePaidSubscribers} />
                  <StatCard icon={Percent} tone="amber" label="Em teste grátis agora" value={stats.activeTrials} />
                  <StatCard icon={DollarSign} tone="indigo" label="MRR estimado" value={money(stats.mrr)} />
                  <StatCard
                    icon={DollarSign}
                    tone="teal"
                  ...
                  />
                  <StatCard icon={UserPlus} tone="indigo" label={`Novos cadastros (${stats.days}d)`} value={stats.newUsersInPeriod} />
                  <StatCard icon={TrendingDown} tone="rose" label={`Cancelamentos (${stats.days}d)`} value={stats.cancelledInPeriod} />
                  <StatCard icon={AlertTriangle} tone="amber" label="Assinaturas em risco" value={stats.atRiskSubscriptions} />
                </div>
